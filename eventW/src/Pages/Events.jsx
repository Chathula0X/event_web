...
function Events() {
  ...
  const events = useMemo(() => ([
    { id: 1, title: 'Summer Music Festival 2025', category: 'Music', date: '2025-07-15', time: '6:00 PM', location: 'Central Park, NYC', price: '$45', img: 'https://img.pikbest.com/templates/2022/11/29010116/fading-style-singer-concert-poster-design_331357.jpg!sw800', description: 'A night filled with music, dance, and fun.' },
    { id: 2, title: 'Startup & Tech Meetup', category: 'Business', date: '2025-06-28', time: '7:00 PM', location: 'Tech Hub, SF', price: 'Free', img: 'https://cdn.venngage.com/template/thumbnail/full/6f7e01e4-6202-447e-8412-84dc2474637f.webp', description: 'Meet founders, developers, and investors.' },
    { id: 3, title: 'International Food & Wine', category: 'Food', date: '2025-08-10', time: '5:00 PM', location: 'Convention Center, Chicago', price: '$120', img: 'https://www.123creative.com/1943-thickbox/rock-concert-poster-template.jpg', description: 'Taste food & wine from all over the world.' },
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to={`/events/${e.id}`}
                    className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-semibold hover:from-purple-700 hover:to-indigo-700 transition"
                  >
                    View Details
                  </Link>
                </div>
